...
void MnChangePage::initializePage()
{
    ...
    UserLineEdit->setText(cmn.m_ssh_user);
    PwdLineEdit->setText(cmn.m_ssh_pwd);
    HashLineEdit->setText(cmn.m_mn_hash);
...
void ChangeDialog::accept()
{
    ...
    cmn.m_ssh_user = QString(mn_user);
    cmn.m_ssh_pwd = QString(mn_pwd);
    cmn.m_mn_key = QString(mn_genkey);
    cmn.m_mn_hash = QString(mn_hash);
